...
function gameLoader(number)
{
	...
	if(num === 1)
	{
	var putContent = '<iframe src="'+ document.URL.split("#",1)+'/migratingFlocks.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/catchTheFlow.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/highOrLow.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/mindMath.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/PassiveOn.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/highClick.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/flashBack.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/mathOperations.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/doubleTrouble.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/driftME.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
	...
	{
	var putContent = '<iframe src="http://karthikeyan5.github.io/Tux4ME/motionCommotion.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
	document.getElementById('GamesPage').innerHTML = putContent;
