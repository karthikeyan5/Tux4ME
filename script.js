...
function gameLoader(number)
{
	...
	{
		//.split("index.html",1)
	var putContent = '<iframe src="'+ document.URL+'/migratingFlocks.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Loading Please wait</iframe> ';
